...
<head>
	<meta charset="UTF-8">
        <title>SwinEDC - login complete</title>
        <meta name="description" content="This page indicates that you have successfully logged in">
...
<br>
	...
	<div id="main">
		...
		<section>
		<h1> Login Success! </h1>
			<p> You have now been logged in. Please use the navigation bar to continue using the site. </p>
		</section>
	</div>
